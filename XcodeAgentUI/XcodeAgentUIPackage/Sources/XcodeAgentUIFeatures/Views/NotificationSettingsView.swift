    ...
    Form {
      ...
      Section("Notification Types") {
        NotificationToggleRow(
          ...
          isOn: Binding(
            get: { notificationManager.approvalNotificationsEnabledValue },
            set: { notificationManager.approvalNotificationsEnabledValue = $0 }
          )
        )
        ...
        NotificationToggleRow(
          ...
          isOn: Binding(
            get: { notificationManager.buildFailedNotificationsEnabledValue },
            set: { notificationManager.buildFailedNotificationsEnabledValue = $0 }
          )
        )
        ...
        NotificationToggleRow(
          ...
          isOn: Binding(
            get: { notificationManager.agentStuckNotificationsEnabledValue },
            set: { notificationManager.agentStuckNotificationsEnabledValue = $0 }
          )
        )
        ...
        NotificationToggleRow(
          ...
          isOn: Binding(
            get: { notificationManager.ticketCompletedNotificationsEnabledValue },
            set: { notificationManager.ticketCompletedNotificationsEnabledValue = $0 }
          )
        )
        ...
        NotificationToggleRow(
          ...
          isOn: Binding(
            get: { notificationManager.tokenThresholdNotificationsEnabledValue },
            set: { notificationManager.tokenThresholdNotificationsEnabledValue = $0 }
          )
        )
      }
      ...
      Section("Thresholds") {
        HStack {
          ...
          Picker("", selection: Binding(
            get: { notificationManager.stuckTimeoutMinutesValue },
            set: { notificationManager.stuckTimeoutMinutesValue = $0 }
          )) {
            Text("5 min").tag(5)
            Text("10 min").tag(10)
            Text("15 min").tag(15)
        ...
        HStack {
          ...
          Spacer()
          Picker("", selection: Binding(
            get: { notificationManager.tokenUsageThresholdPercentValue },
            set: { notificationManager.tokenUsageThresholdPercentValue = $0 }
          )) {
            Text("50%").tag(50)
            Text("60%").tag(60)
            Text("70%").tag(70)
      ...
      Section("Sound") {
        Toggle("Play notification sound", isOn: Binding(
          get: { notificationManager.soundEnabledValue },
          set: { notificationManager.soundEnabledValue = $0 }
        ))
      }
