...
public final class ConnectionManager {
    ...
    public var availableProfiles: [ConnectionProfile] = []
    public var feedMode: FeedMode = .offline
    ...
    public init(webSocket: BridgeWebSocket? = nil) {
        self.store = .shared
    ...
    public func connect(to profile: ConnectionProfile, maxRetries: Int = 0) async {
    ...
    public func connectToFastest(timeout: TimeInterval = 10) async {
    ...
    public func handleWebSocketFailure(reason: String) {
    ...
    public func markWebSocketRecovered() {
    ...
    public func probeResult(for profileID: UUID) -> ProbeResult? {
