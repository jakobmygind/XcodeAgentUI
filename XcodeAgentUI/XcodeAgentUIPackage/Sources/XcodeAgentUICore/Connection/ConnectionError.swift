...
public enum ConnectionError: LocalizedError, Sendable, Equatable {
    ...
    public func isEqual(to other: ConnectionError) -> Bool {
        switch (self, other) {
...
public enum FeedMode: Equatable, Sendable {
...
public struct ProbeResult: Sendable {
    ...
    public let healthResponse: HealthResponse?
    ...
    public static func failure(profile: ConnectionProfile, error: ConnectionError) -> ProbeResult {
        ProbeResult(
            profile: profile,
            latencyMs: -1,
            timestamp: Date(),
