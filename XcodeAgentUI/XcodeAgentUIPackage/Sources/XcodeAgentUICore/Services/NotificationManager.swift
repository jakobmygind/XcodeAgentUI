...
public final class NotificationManager: NSObject, UNUserNotificationCenterDelegate, @unchecked Sendable {
  public nonisolated(unsafe) static let shared = NotificationManager()

  // MARK: - Preferences (persisted via @Shared)

  @ObservationIgnored
  @Shared(.appStorage("notif_approval"))
  public var approvalNotificationsEnabled = true

  @ObservationIgnored
  @Shared(.appStorage("notif_buildFailed"))
  public var buildFailedNotificationsEnabled = true

  @ObservationIgnored
  @Shared(.appStorage("notif_agentStuck"))
  public var agentStuckNotificationsEnabled = true

  @ObservationIgnored
  @Shared(.appStorage("notif_ticketCompleted"))
  public var ticketCompletedNotificationsEnabled = true

  @ObservationIgnored
  @Shared(.appStorage("notif_tokenThreshold"))
  public var tokenThresholdNotificationsEnabled = true

  @ObservationIgnored
  @Shared(.appStorage("notif_stuckTimeout"))
  public var stuckTimeoutMinutes = 10

  @ObservationIgnored
  @Shared(.appStorage("notif_tokenThresholdPercent"))
  public var tokenUsageThresholdPercent = 80
  ...
  public var onActionReceived: ((NotificationAction, String) -> Void)?

  public var recentNotifications: [NotificationRecord] = []

  public var approvalNotificationsEnabledValue: Bool {
    get { approvalNotificationsEnabled }
    set { $approvalNotificationsEnabled.withLock { $0 = newValue } }
  }

  public var buildFailedNotificationsEnabledValue: Bool {
    get { buildFailedNotificationsEnabled }
    set { $buildFailedNotificationsEnabled.withLock { $0 = newValue } }
  }

  public var agentStuckNotificationsEnabledValue: Bool {
    get { agentStuckNotificationsEnabled }
    set { $agentStuckNotificationsEnabled.withLock { $0 = newValue } }
  }

  public var ticketCompletedNotificationsEnabledValue: Bool {
    get { ticketCompletedNotificationsEnabled }
    set { $ticketCompletedNotificationsEnabled.withLock { $0 = newValue } }
  }

  public var tokenThresholdNotificationsEnabledValue: Bool {
    get { tokenThresholdNotificationsEnabled }
    set { $tokenThresholdNotificationsEnabled.withLock { $0 = newValue } }
  }

  public var stuckTimeoutMinutesValue: Int {
    get { stuckTimeoutMinutes }
    set { $stuckTimeoutMinutes.withLock { $0 = newValue } }
  }

  public var tokenUsageThresholdPercentValue: Int {
    get { tokenUsageThresholdPercent }
    set { $tokenUsageThresholdPercent.withLock { $0 = newValue } }
  }

  public var soundEnabledValue: Bool {
    get { soundEnabled }
    set { $soundEnabled.withLock { $0 = newValue } }
  }
  ...
  @MainActor
  public func setApprovalNotificationsEnabled(_ value: Bool) {
    $approvalNotificationsEnabled.withLock { $0 = value }
  }

  @MainActor
  public func setBuildFailedNotificationsEnabled(_ value: Bool) {
    $buildFailedNotificationsEnabled.withLock { $0 = value }
  }

  @MainActor
  public func setAgentStuckNotificationsEnabled(_ value: Bool) {
    $agentStuckNotificationsEnabled.withLock { $0 = value }
  }

  @MainActor
  public func setTicketCompletedNotificationsEnabled(_ value: Bool) {
    $ticketCompletedNotificationsEnabled.withLock { $0 = value }
  }

  @MainActor
  public func setTokenThresholdNotificationsEnabled(_ value: Bool) {
    $tokenThresholdNotificationsEnabled.withLock { $0 = value }
  }

  @MainActor
  public func setStuckTimeoutMinutes(_ value: Int) {
    $stuckTimeoutMinutes.withLock { $0 = value }
  }

  @MainActor
  public func setTokenUsageThresholdPercent(_ value: Int) {
    $tokenUsageThresholdPercent.withLock { $0 = value }
  }

  @MainActor
  public func setSoundEnabled(_ value: Bool) {
    $soundEnabled.withLock { $0 = value }
  }
...
public struct NotificationRecord: Identifiable {
  public let id = UUID()
