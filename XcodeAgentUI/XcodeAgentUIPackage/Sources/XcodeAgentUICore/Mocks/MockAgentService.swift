...
@MainActor
public final class MockAgentService: AgentService {

  public static let shared = MockAgentService()
...
public enum MockSessionManager {
  @MainActor
  public static func create() -> SessionManager {
