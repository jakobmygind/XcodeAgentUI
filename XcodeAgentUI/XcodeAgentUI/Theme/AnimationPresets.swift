...
enum XARAnimation {
  ...
  static let elastic = Animation.spring(response: 0.5, dampingFraction: 0.65)
  ...
  static let dramatic = Animation.spring(response: 0.7, dampingFraction: 0.7)
  ...
  static let mediumDuration: Double = 0.4
}
