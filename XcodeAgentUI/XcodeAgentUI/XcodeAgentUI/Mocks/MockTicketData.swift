...
enum MockTicketData {
  ...
  static let sampleTicketRuns: [TicketRun] = [
    TicketRun(
      ticketID: "MOBILE-2801", project: "ios-shopping-app", agentModel: "Opus",
      startedAt: Date().addingTimeInterval(-86400 * 3), durationSeconds: 480,
      tokensUsed: 52_000, succeeded: true
    ),
    TicketRun(
      ticketID: "MOBILE-2810", project: "ios-shopping-app", agentModel: "Sonnet",
      startedAt: Date().addingTimeInterval(-86400 * 2), durationSeconds: 320,
      tokensUsed: 28_000, succeeded: true
    ),
    TicketRun(
      ticketID: "WEB-438", project: "marketing-site", agentModel: "Sonnet",
      startedAt: Date().addingTimeInterval(-86400 * 2), durationSeconds: 190,
      tokensUsed: 15_000, succeeded: true
    ),
    TicketRun(
      ticketID: "API-305", project: "rest-api-v3", agentModel: "Opus",
      startedAt: Date().addingTimeInterval(-86400), durationSeconds: 620,
      tokensUsed: 68_000, succeeded: false
    ),
    TicketRun(
      ticketID: "MOBILE-2840", project: "ios-shopping-app", agentModel: "Sonnet",
      startedAt: Date().addingTimeInterval(-43200), durationSeconds: 250,
      tokensUsed: 22_000, succeeded: true
    ),
  ]
