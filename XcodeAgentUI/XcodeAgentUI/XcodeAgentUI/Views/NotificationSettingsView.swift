...
/// Settings view for configuring Smart Notification preferences
    ...
    Form {
      ...
      Section("Notification Types") {
        NotificationToggleRow(
          ...
          isOn: $notificationManager.approvalNotificationsEnabled
        )
        ...
        NotificationToggleRow(
          ...
          isOn: $notificationManager.buildFailedNotificationsEnabled
        )
        ...
        NotificationToggleRow(
          ...
          isOn: $notificationManager.agentStuckNotificationsEnabled
        )
        ...
        NotificationToggleRow(
          ...
          isOn: $notificationManager.ticketCompletedNotificationsEnabled
        )
        ...
        NotificationToggleRow(
          ...
          isOn: $notificationManager.tokenThresholdNotificationsEnabled
        )
      }
      ...
      Section("Thresholds") {
        HStack {
          Text("Stuck timeout")
          Spacer()
          Picker("", selection: $notificationManager.stuckTimeoutMinutes) {
            Text("5 min").tag(5)
            Text("10 min").tag(10)
            Text("15 min").tag(15)
            Text("20 min").tag(20)
        ...
        HStack {
          ...
          Spacer()
          Picker("", selection: $notificationManager.tokenUsageThresholdPercent) {
            Text("50%").tag(50)
            Text("60%").tag(60)
            Text("70%").tag(70)
            Text("80%").tag(80)
      ...
      // Sound
      Section("Sound") {
        Toggle("Play notification sound", isOn: $notificationManager.soundEnabled)
      }
