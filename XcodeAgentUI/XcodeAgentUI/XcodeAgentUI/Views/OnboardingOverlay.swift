...
struct OnboardingOverlay: View {
    ...
    @ObservedObject var defaults = SmartDefaults.shared
    ...
    private let steps: [OnboardingStep] = [
        ...
        OnboardingStep(
            ...
            subtitle: "Router + Bridge = Ready",
            description: "The Router handles AI provider connections. The Bridge manages real-time communication with agents. Start both to begin.",
            icon: "power",
