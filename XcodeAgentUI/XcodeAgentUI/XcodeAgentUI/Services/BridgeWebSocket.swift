...
/// WebSocket client for the Xcode Agent Bridge
class BridgeWebSocket: ObservableObject {
  @Published var isConnected = false
  @Published var messages: [BridgeEnvelope] = []
  @Published var connectedClients: [BridgeClient] = []
  ...
  private func handleMessage(_ text: String) {
    ...
    DispatchQueue.main.async {
      ...
      // Track client connections from system messages
